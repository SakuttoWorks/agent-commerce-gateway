...
This service is a data processing infrastructure, **NOT** a financial advisor.  
Please read our `LEGAL.md` carefully.

* We do **NOT** provide financial analysis, trading signals, or investment advice.
* We do **NOT** maintain proprietary market databases.
* The "Commerce" in our name refers strictly to API Metered Billing Infrastructure, not financial trading.
